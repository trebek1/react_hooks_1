...
function Tasks() {
  ...
  // setter functions replace the whole value now
  // so dont want to have one setter for whole state
  // break them out
  ...
  return (
    <div>
      ...
      <div className="task-list">
        {tasks.map(task => (
          <div onClick={completeTask(task)} key={task.id}>
            {task.taskText}
          </div>
        ))}
      </div>
